...
describe("Yandex3", () => 
{
    ...
    {
        it("sortStr 1", () =>
            assert (YandexTasks.Yandex3.sortStr("badoc") == "abcdo"))
    })

    describe("markStr", () =>
    {
        it("markStr 1", () =>
            assert (YandexTasks.Yandex3.markStr("badoc") == {s: "badoc", m: "abcdo"}))
    })

    describe("findStoreByMark", () =>
    {
        it("findStoreByMark 1", () =>
            assert (YandexTasks.Yandex3.findStoreByMark( [{stor: ["a"], m: "a"}, {stor: ["b"], m: "b"}], "a")
                ->Js.Option.getExn == {stor: ["a"], m: "a"}))
        
        it("findStoreByMark 2", () =>
            assert (YandexTasks.Yandex3.findStoreByMark( [{stor: ["a"], m: "a"}, {stor: ["b"], m: "b"}], "c")
    ...
    describe("groupMarkedStrs", () =>
    {
        it("groupMarkedStrs 1", () =>
                assert (YandexTasks.Yandex3.groupMarkedStrs(
    ...
    {
        it("groupStrings 1", () =>
            assert (YandexTasks.Yandex3.groupStrings(["eat", "tea", "tan", "ate", "nat", "bat"])
